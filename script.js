...
function generatePassword() {
  ...
  const passwordLength = window.prompt("How long would you like you password to be? Choose between 8 and 128 Characters");
  ...
  //window.alert("Your secure password is " + yourPassword)
